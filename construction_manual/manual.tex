...
\subfigure[Remove the dust container]{\label{fig:remove_dust_container}\includegraphics[width=0.45\textwidth]{media/resized/12.png}}
\subfigure[Remove the underbody cover lid to gain access to the battery and main brushes]{\label{fig:remove underbody}\includegraphics[width=0.45\textwidth]{media/resized/13.png}}
\subfigure[Take out the main brush system]{\label{fig:b}\includegraphics[width=0.45\textwidth]{media/resized/14.png}}

\subfigure[Re-attach the underbody lid and the dust container]{\label{fig:b}\includegraphics[width=0.45\textwidth]{media/resized/1.png}}
\subfigure[Your robot is now operational]{\label{fig:upside_down}\includegraphics[width=0.45\textwidth]{media/resized/2.png}}
...
So far you can use the following scripts:

\begin{itemize}
 \item $main.m$ - you are asked what you want to write
 \item $main_xbox.m$ - move the robot with your xbox controller
\end{itemize}

If you have trouble establishing a connection through your USB interface, check if you have the rights to write on it.
