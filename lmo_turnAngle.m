function lmo_turnAngle(serPort, roombaSpeed, turnAngle)
...
try
    ...
    if turnAngle ~=0
        full_rotation_distance_mm   = 2 * pi * 235/2;%this is 360degrees
        rotation_desired__mm        = full_rotation_distance_mm/360 *(abs(turnAngle));
        m_to_mm = 1000;
        calib_factor = 170;%should be 0
        m_to_mm_calib = m_to_mm + calib_factor;%%%vary bad...sshould be 1000
        var = rotation_desired__mm/ (roombaSpeed*m_to_mm_calib);
